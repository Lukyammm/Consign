...
## 9. Pré-cadastro de Acompanhantes (ocupação rápida)
- Use a página **Pré-cadastro Acompanhantes** para registrar armários que já estavam ocupados antes da implantação.
- Preencha o card de "Ocupar armário" com número, paciente, prontuário e acompanhante (nenhum campo é obrigatório).
- A tabela abaixo lista armários livres; clique em **Selecionar** para preencher o formulário rapidamente ou salve todos os rascunhos de uma vez.
...
## 17. Checklist rápido antes de finalizar o dia
